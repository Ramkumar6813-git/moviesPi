<div align="center">
  <br />
    <a href="https://www.youtube.com/watch?v=dCLhUialKPQ" target="_blank">
      <img src="public/movie-banner.png" alt="Project Banner">
    </a>
  <br />
  ...
  <h3 align="center">A Movie Application - MoviesPI</h3>

   <div align="center">
     Built this project step by step from <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a> YouTube.
    </div>
</div>
...
### Topis of fetaures implemented here
- `abort controller` in react 
- use of `tailwindcss V4` features
- `encodeURIComponent`
- `useDebounceHook` for optimization by delaying fetch api calls
